...
(function(global) {
  ...
  function makeError(e, t, n, r) {
    ...
    return (
      (i.requireType = e), (i.requireModules = r), n && (i.originalError = n), i
    );
  }
  function newContext(e) {
    ...
    function b(e) {
      ...
      if (t && isArray(t) && t.length > 1)
        return t.shift(), r.require.undef(e), r.require([e]), !0;
    }
    function w(e) {
      var t,
        n = e ? e.indexOf("!") : -1;
    ...
    function x(e, t, n) {
      var r = e.id,
        i = getOwn(u, r);
      hasProp(c, r) && (!i || i.defineEmitComplete)
        ? t === "defined" && n(c[r])
        : ((i = S(e)), i.error && t === "error" ? n(i.error) : i.on(t, n));
    }
    function T(e, t) {
      ...
      t
        ...
        : (each(n, function(t) {
            var n = getOwn(u, t);
            n &&
              ((n.error = e), n.events.error && ((r = !0), n.emit("error", e)));
          }),
          r || req.onError(e));
    }
    function N() {
        ...
        : ((t[r] = !0),
          each(e.depMaps, function(r, i) {
            ...
            o &&
              !e.depMatched[i] &&
              !n[s] &&
              (getOwn(t, s) ? (e.defineDep(i, c[s]), e.check()) : k(o, t, n));
          }),
          (n[r] = !0));
    }
    function L() {
    ...
    return (
      (i = {
        ...
        exports: function(e) {
          ...
          if (e.map.isDefine)
            return e.exports
              ? (c[e.map.id] = e.exports)
              : (e.exports = c[e.map.id] = {});
        },
        module: function(e) {
          return e.module
            ? e.module
            ...
            if (this.depCount < 1 && !this.defined) {
              if (isFunction(o)) {
                ...
                this.map.isDefine &&
                  ...
                  t
                    ? (s = t.exports)
                    : this.usingExports && (s = this.exports));
                if (e)
                  return (
        ...
        makeRequire: function(t, n) {
          function s(o, a, f) {
            ...
            return (
              ...
              typeof o == "string"
                ? isFunction(a)
                  ? T(makeError("requireargs", "Invalid require call"), f)
                  : t && hasProp(i, o)
                  ? i[o](u[t.id])
                  : req.get
                  ? req.get(r, o, t, s)
            ...
            mixin(s, {
              ...
              toUrl: function(e) {
                ...
                return (
                  i !== -1 &&
                    (!o || i > 1) &&
                    ((n = e.substring(i, e.length)), (e = e.substring(0, i))),
  ...
  (function(e, t) {
        ...
        n === "margin" && (o += jQuery.css(e, n + cssExpand[s], !0, i)),
          r
            ? (n === "content" &&
              ...
              n !== "margin" &&
                (o -= jQuery.css(e, "border" + cssExpand[s] + "Width", !0, i)))
            : ((o += jQuery.css(e, "padding" + cssExpand[s], !0, i)),
              n !== "padding" &&
                (o += jQuery.css(e, "border" + cssExpand[s] + "Width", !0, i)));
      return o;
    ...
    function getWidthOrHeight(e, t, n) {
      ...
      return (
        i +
        augmentWidthOrHeight(e, t, n || (o ? "border" : "content"), r, s) +
        "px"
      );
    }
    ...
    function defaultPrefilter(e, t, n) {
      ...
      n.queue ||
        ...
        e.nodeType === 1 &&
          ...
          (l =
            f === "none"
              ? data_priv.get(e, "olddisplay") || defaultDisplay(e.nodeName)
              : f),
          l === "inline" &&
    ...
    (jQuery.fn = jQuery.prototype = {
      ...
      jQuery.extend({
        ...
        isPlainObject: function(e) {
          return jQuery.type(e) !== "object" || e.nodeType || jQuery.isWindow(e)
            ? !1
            : e.constructor &&
    ...
    (jQuery.filter = function(e, t, n) {
      ...
      jQuery.fn.extend({
        ...
        is: function(e) {
          return !!winnow(
            this,
            typeof e == "string" && rneedsContext.test(e) ? jQuery(e) : e || [],
            !1
          ).length;
        }
      });
            ...
            if (n[1]) {
              (t = t instanceof jQuery ? t[0] : t),
                jQuery.merge(
                  ...
                  jQuery.parseHTML(
                    n[1],
                    t && t.nodeType ? t.ownerDocument || t : document,
                    !0
                  )
                );
      ...
      jQuery.fn.extend({
        ...
        closest: function(e, t) {
          var n,
            ...
            s = [],
            o =
              rneedsContext.test(e) || typeof e != "string"
          ...
          for (; r < i; r++)
            for (n = this[r]; n && n !== t; n = n.parentNode)
              if (
                ...
                (o
                  ? o.index(n) > -1
                  : n.nodeType === 1 && jQuery.find.matchesSelector(n, e))
              ) {
                s.push(n);
                break;
              }
      ...
      (Data.prototype = {
        ...
        access: function(e, t, n) {
          ...
          return t === undefined ||
            ...
            ? ((r = this.get(e, t)),
              r !== undefined ? r : this.get(e, jQuery.camelCase(t)))
          ...
          if (t === undefined) this.cache[s] = {};
            ...
            jQuery.isArray(t)
              ...
              : ((i = jQuery.camelCase(t)),
                t in o
                  ? (r = [t, i])
                  : ((r = i), (r = r in o ? [r] : r.match(rnotwhite) || []))),
              (n = r.length);
    ...
    (jQuery.event = {
        ...
        while (f--) {
          ...
          (c = jQuery.event.special[p] || {}),
            ...
            (h = a[p]) ||
              ((h = a[p] = []),
              (h.delegateCount = 0),
              (!c.setup || c.setup.call(e, r, d, o) === !1) &&
                e.addEventListener &&
      ...
      trigger: function(e, t, n, r) {
        ...
        h.indexOf(".") >= 0 && ((p = h.split(".")), (h = p.shift()), p.sort()),
          ...
          (e = e[jQuery.expando]
            ? e
            : new jQuery.Event(h, typeof e == "object" && e)),
          (e.isTrigger = r ? 2 : 3),
          (e.namespace = p.join(".")),
        ...
        while ((s = c[i++]) && !e.isPropagationStopped())
          (e.type = i > 1 ? u : l.bindType || h),
            (f =
              (data_priv.get(s, "events") || {})[e.type] &&
              data_priv.get(s, "handle")),
            f && f.apply(s, t),
            (f = a && s[a]),
            f &&
              f.apply &&
          ...
          while ((s = i.handlers[n++]) && !e.isImmediatePropagationStopped())
            if (!e.namespace_re || e.namespace_re.test(s.namespace))
              (e.handleObj = s),
                (e.data = s.data),
                (r = (
                  (jQuery.event.special[s.origType] || {}).handle || s.handler
                ).apply(i.elem, u)),
                r !== undefined &&
                  (e.result = r) === !1 &&
                ...
                (s = t[n]),
                  ...
                  r[i] === undefined &&
                    (r[i] = s.needsContext
                      ...
                      : jQuery.find(i, this, null, [a]).length),
                  r[i] && r.push(s);
          ...
          jQuery.event.special[t] = {
            ...
            teardown: function() {
              ...
              i
                ...
                : (r.removeEventListener(e, n, !0), data_priv.remove(r, t));
            }
          };
        }),
      jQuery.fn.extend({
            ...
            if (i || i === 0)
              if (jQuery.type(i) === "object")
                ...
                (s = s || l.appendChild(t.createElement("div"))),
                  ...
                  (s.innerHTML =
                    u[1] + i.replace(rxhtmlTag, "<$1></$2>") + u[2]),
                  (f = u[0]);
          ...
          return access(
            ...
            function(e) {
              ...
              if (
                typeof e == "string" &&
                !rnoInnerhtml.test(e) &&
                !wrapMap[(rtagName.exec(e) || ["", ""])[1].toLowerCase()]
              ) {
                ...
                for (a = 0; a < s; a++)
                  (o = i[a]),
                    rscriptType.test(o.type || "") &&
                      ...
                      jQuery.contains(u, o) &&
                      (o.src
                        ? jQuery._evalUrl && jQuery._evalUrl(o.src)
                        : jQuery.globalEval(
                            o.textContent.replace(rcleanScript, "")
                          ));
              }
            }
          }
    ...
    jQuery.extend({
      ...
      css: function(e, t, n, r) {
        ...
        return (
          (t =
            jQuery.cssProps[u] ||
            (jQuery.cssProps[u] = vendorPropName(e.style, u))),
          (o = jQuery.cssHooks[t] || jQuery.cssHooks[u]),
      ...
      jQuery.each(["height", "width"], function(e, t) {
        jQuery.cssHooks[t] = {
          get: function(e, n, r) {
            if (n)
              return rdisplayswap.test(jQuery.css(e, "display")) &&
                e.offsetWidth === 0
            ...
            return setPositiveNumber(
              ...
              r
                ? augmentWidthOrHeight(
                    ...
                    t,
                    r,
                    jQuery.css(e, "boxSizing", !1, i) === "border-box",
                    i
                  )
                : 0
            );
      ...
      (jQuery.cssHooks.marginRight = addGetHookIf(
        ...
        function(e, t) {
          if (t)
            return jQuery.swap(e, { display: "inline-block" }, curCSS, [
              e,
              "marginRight"
            ]);
        }
        ...
        _default: {
          ...
          set: function(e) {
            jQuery.fx.step[e.prop]
              ...
              : e.elem.style &&
                (e.elem.style[jQuery.cssProps[e.prop]] != null ||
        ...
        attr: function(e, t, n) {
          ...
          if (s !== 1 || !jQuery.isXMLDoc(e))
            (t = t.toLowerCase()),
              (r =
                jQuery.attrHooks[t] ||
                (jQuery.expr.match.bool.test(t) ? boolHook : nodeHook));
          if (n === undefined)
            return r && "get" in r && (i = r.get(e, t)) !== null
              ? i
              : ((i = jQuery.find.attr(e, t)), i == null ? undefined : i);
          if (n !== null)
    ...
    jQuery.fn.extend({
      ...
      hasClass: function(e) {
        ...
        for (; n < r; n++)
          if (
            this[n].nodeType === 1 &&
            (" " + this[n].className + " ").replace(rclass, " ").indexOf(t) >= 0
          )
            return !0;
        return !1;
      }
              ...
              for (; a < u; a++) {
                ...
                if (
                  ...
                  (!n.parentNode.disabled ||
                    !jQuery.nodeName(n.parentNode, "optgroup"))
                ) {
                  t = jQuery(n).val();
                  if (s) return t;
                  o.push(t);
    ...
    (ajaxLocParts = rurl.exec(ajaxLocation.toLowerCase()) || []),
      jQuery.extend({
        ...
        ajax: function(e, t) {
          ...
          var n,
            ...
            c = l.context || l,
            h =
              l.context && (c.nodeType || c.jquery) ? jQuery(c) : jQuery.event,
            p = jQuery.Deferred(),
      ...
      jQuery.each(["get", "post"], function(e, t) {
        jQuery[t] = function(e, n, r, i) {
          return (
            jQuery.isFunction(n) && ((i = i || r), (r = n), (n = undefined)),
            jQuery.ajax({ url: e, type: t, dataType: i, data: n, success: r })
          );
        };
      }),
      jQuery.each(
                ...
                return function() {
                  t &&
                    ...
                    e === "abort"
                      ...
                      : r(
                          xhrSuccessStatus[s.status] || s.status,
                          s.statusText,
    ...
    jQuery.ajaxSetup({
      ...
      jQuery.ajaxPrefilter("json jsonp", function(e, t, n) {
        ...
        if (o || e.dataTypes[0] === "jsonp")
          return (
            (r = e.jsonpCallback = jQuery.isFunction(e.jsonpCallback)
              ? e.jsonpCallback()
              : e.jsonpCallback),
            o
            ...
            n.always(function() {
              (window[r] = i),
                e[r] &&
                  ((e.jsonpCallback = t.jsonpCallback), oldCallbacks.push(r)),
    ...
    (jQuery.fn.load = function(e, t, n) {
      ...
      var r,
        ...
        u = e.indexOf(" ");
      return (
        u >= 0 && ((r = jQuery.trim(e.slice(u))), (e = e.slice(0, u))),
        jQuery.isFunction(t)
          ? ((n = t), (t = undefined))
    ...
    (jQuery.offset = {
      ...
      jQuery.each(["top", "left"], function(e, t) {
        jQuery.cssHooks[t] = addGetHookIf(support.pixelPosition, function(
          e,
          n
        ) {
          if (n)
  ...
  define("utils/sharing", ["jQuery"], function(e) {
    var t = {
        twitter: function(t) {
          window.open(
            "http://twitter.com/home?status=" +
              encodeURIComponent(e("title").text() + " " + location.href)
          );
        },
        facebook: function(e) {
          window.open(
        ...
        weibo: function(t) {
          window.open(
            "http://service.weibo.com/share/share.php?content=utf-8&url=" +
              encodeURIComponent(location.href) +
              "&title=" +
              encodeURIComponent(e("title").text())
          );
        },
      ...
      n = function() {
        e(document).on(
          "click",
          "a[data-sharing],button[data-sharing]",
          function(n) {
            n && n.preventDefault();
    ...
    var n,
      ...
      f = function() {
        ...
        e(".font-settings .font-family-list li").removeClass("active"),
          ...
          n.theme !== 0 &&
            ((t[0].className = t[0].className.replace(
              /\bcolor-theme-\S+/g,
              ""
            )),
      ...
      l = function(l) {
        ...
        (d = e(".book")),
          ...
          e(document).on(
            "click",
            "#font-settings-wrapper .font-family-list .button",
            u
          ),
          e(document).on(
            "click",
            "#font-settings-wrapper .color-theme-list .button",
            a
          );
      };
    return { init: l, update: f };
  }),
  ...
  (function(e, t, n) {
    ...
    function w(e, t, n, r, i, s) {
      ...
      for (o = 0; o < a[e].length; ++o) {
        ...
        if (
          (c == "keypress" && !n.metaKey && !n.ctrlKey) ||
          y(t, u.modifiers)
        ) {
          var h = !r && u.combo == i,
    ...
    function D(e, t) {
      ...
      for (i = 0; i < n.length; ++i)
        (r = n[i]),
          o[r] && (r = o[r]),
          t && t != "keypress" && s[r] && ((r = s[r]), u.push("shift")),
          k(r) && u.push(r);
      return (t = O(r, u, t)), { key: r, modifiers: u, action: t };
    }
    function P(e, t, n, r, i) {
      ...
      (o = D(e, n)),
        (a[o.key] = a[o.key] || []),
        w(o.key, o.modifiers, { type: o.action }, r, e, i),
  ...
  (function(e) {
    ...
    function O(e) {
      ...
      for (v = 0; v < d; ++v)
        e.charCodeAt(v) >= 128 && S("not-basic"), t.push(e.charCodeAt(v));
      for (m = d > 0 ? d + 1 : 0; m < n; ) {
        for (g = i, y = 1, w = o; ; w += o) {
          m >= n && S("invalid-input"),
            (E = k(e.charCodeAt(m++))),
  ...
  (function(e, t) {
    typeof exports == "object"
      ? (module.exports = t())
      : typeof define == "function" && define.amd
      ? define("URIjs/SecondLevelDomains", t)
  ...
  (function(e, t) {
    typeof exports == "object"
      ...
      : typeof define == "function" && define.amd
      ? define("URIjs/URI", ["./punycode", "./IPv6", "./SecondLevelDomains"], t)
    ...
    function c(e, t) {
      var n = {},
        r,
        i;
      if (l(t)) for (r = 0, i = t.length; r < i; r++) n[t[r]] = !0;
      else n[t] = !0;
      for (r = 0, i = e.length; r < i; r++)
        n[e[r]] !== undefined && (e.splice(r, 1), i--, r--);
      return e;
    }
    function h(e, t) {
      var n, r;
      if (l(t)) {
        for (n = 0, r = t.length; n < r; n++) if (!h(e, t[n])) return !1;
        return !0;
      }
      var i = f(t);
    ...
    var m = { encode: "encode", decode: "decode" },
      g,
      y = function(e, t) {
        return function(n) {
          return s[t](n + "").replace(s.characters[e][t].expression, function(
            n
          ) {
    ...
    (s.encodeReserved = y("reserved", "encode")),
          ...
          e.substring(0, 2) === "//"
            ...
            : ((n = e.indexOf(":")),
              n > -1 &&
                ...
                t.protocol && !t.protocol.match(s.protocol_expression)
                  ? (t.protocol = undefined)
                  : t.protocol === "file"
                  ? (e = e.substring(n + 3))
                  : e.substring(n + 1, n + 3) === "//"
                  ? ((e = e.substring(n + 3)), (e = s.parseAuthority(e, t)))
      ...
      (s.parseQuery = function(e, t) {
        ...
        for (var f = 0; f < i; f++)
          (o = r[f].split("=")),
            ...
            n[u]
              ? (typeof n[u] == "string" && (n[u] = [n[u]]), n[u].push(a))
              : (n[u] = a);
        return n;
      }),
      (s.build = function(e) {
      ...
      (s.buildHost = function(e) {
        var t = "";
        return e.hostname
          ? (s.ip6_expression.test(e.hostname)
              ? (t += "[" + e.hostname + "]")
              : (t += e.hostname),
            e.port && (t += ":" + e.port),
            t)
      ...
      (s.buildQuery = function(e, t, n) {
        ...
        for (o in e)
          if (u.call(e, o) && o)
            if (l(e[o])) {
              i = {};
              for (a = 0, f = e[o].length; a < f; a++)
                e[o][a] !== undefined &&
                  i[e[o][a] + ""] === undefined &&
                  ((r += "&" + s.buildQueryParameter(o, e[o][a], n)),
                  t !== !0 && (i[e[o][a] + ""] = !0));
            } else
              e[o] !== undefined &&
                (r += "&" + s.buildQueryParameter(o, e[o], n));
        return r.substring(1);
      }),
      (s.buildQueryParameter = function(e, t, n) {
        return (
          s.encodeQuery(e, n) + (t !== null ? "=" + s.encodeQuery(t, n) : "")
        );
      }),
      ...
      (s.removeQuery = function(e, t, n) {
        var r, i, o;
        if (l(t)) for (r = 0, i = t.length; r < i; r++) e[t[r]] = undefined;
      ...
      (o.build = function(e) {
        if (e === !0) this._deferred_build = !0;
          ...
          (this._string = s.build(this._parts)), (this._deferred_build = !1);
        return this;
      }),
      (o.clone = function() {
        return new s(this);
    ...
    (o.pathname = function(e, t) {
      ...
      return (
        (this._parts.path = e ? s.recodePath(e) : "/"), this.build(!t), this
      );
    }),
      (o.path = o.pathname),
      (o.href = function(e, t) {
    ...
    (o.protocol = function(e, t) {
      ...
      (o.host = function(e, t) {
        return this._parts.urn
          ...
          : e === undefined
          ? this._parts.hostname
            ? s.buildHost(this._parts)
            : ""
          : (s.parseHost(e, this._parts), this.build(!t), this);
      }),
      (o.authority = function(e, t) {
        return this._parts.urn
          ...
          : e === undefined
          ? this._parts.hostname
            ? s.buildAuthority(this._parts)
            : ""
          : (s.parseAuthority(e, this._parts), this.build(!t), this);
      }),
      ...
      (o.tld = function(e, t) {
        ...
        if (e === undefined) {
          ...
          return t !== !0 && n && n.list[i.toLowerCase()]
      ...
      (o.segmentCoded = function(e, t, n) {
        ...
        if (t === undefined) {
          ...
          else for (i = 0, o = r.length; i < o; i++) r[i] = s.decode(r[i]);
          return r;
        }
        if (!l(t)) t = typeof t == "string" ? s.encode(t) : t;
        else for (i = 0, o = t.length; i < o; i++) t[i] = s.decode(t[i]);
    ...
    return (
      ...
      (o.addQuery = function(e, t, n) {
        var r = s.parseQuery(this._parts.query, this._parts.escapeQuerySpace);
        return (
          s.addQuery(r, e, t === undefined ? null : t),
          (this._parts.query = s.buildQuery(
            r,
            this._parts.duplicateQueryParameters,
            this._parts.escapeQuerySpace
      ...
      (o.normalizePath = function(e) {
        ...
        return (
          t && this.is("relative") && (n = r + n.substring(1)),
          (n = s.recodePath(n)),
          (this._parts.path = n),
          this.build(!e),
          this
      ...
      (o.readable = function() {
        ...
        if (t._parts.query) {
          var r = "";
          for (
            var i = 0, o = t._parts.query.split("&"), u = o.length;
            i < u;
            i++
          ) {
            var a = (o[i] || "").split("=");
            (r +=
              "&" +
              s
                .decodeQuery(a[0], this._parts.escapeQuerySpace)
                .replace(/&/g, "%26")),
              a[1] !== undefined &&
                (r +=
                  "=" +
                  s
                    .decodeQuery(a[1], this._parts.escapeQuerySpace)
                    .replace(/&/g, "%26"));
          }
          n += "?" + r.substring(1);
        }
      ...
      (o.absoluteTo = function(e) {
        ...
        return (
          t._parts.path
            ? t._parts.path.substring(-2) === ".." && (t._parts.path += "/")
  ...
  define("utils/url", ["URIjs/URI"], function(e) {
    ...
    function r(e) {
      return e
        ? e[0] == "/" || e.indexOf("http://") == 0 || e.indexOf("https://") == 0
        : !1;
    }
    return { dirname: n, join: t, isAbsolute: r };
  }),
  function() {
    function q(e, t, n) {
      var r = (n || 0) - 1,
    ...
    function Y(t) {
      function Lt(e) {
        return e && typeof e == "object" && !Gt(e) && ht.call(e, "__wrapped__")
          ? e
          : new At(e);
      }
      function At(e, t) {
      ...
      function _t(e, t, n, r, i) {
        ...
        if (t) {
          ...
          r || (r = $()), i || (i = $());
          var c = r.length;
          while (c--) if (r[c] == e) return i[c];
          s = f ? a(e.length) : {};
        } else s = f ? G(e) : sn({}, e);
        return (
          f &&
            (ht.call(e, "index") && (s.index = e.index),
      ...
      function Ht(e) {
        function h() {
          ...
          if (i || f) {
            ...
            if (f && p.length < o)
              return (n |= 16), Ht([t, l ? n : n & -4, p, null, s, o]);
          }
      ...
      function Ft(e, t, n, r, i, s) {
        ...
        if (!c) {
          ...
          if (
            d != v &&
            !(Nn(d) && d instanceof d && Nn(v) && v instanceof v) &&
            "constructor" in e &&
            "constructor" in t
          )
            return !1;
          ...
          if (o || r)
            while (y--) {
              var b = g,
                w = t[y];
              if (r) {
                while (b--) if ((o = Ft(e[b], w, n, r, i, s))) break;
              } else if (!(o = Ft(e[y], w, n, r, i, s))) break;
            }
        } else
          hn(t, function(t, u, a) {
            if (ht.call(a, u))
              return y++, (o = ht.call(e, u) && Ft(e[u], t, n, r, i, s));
          }),
            o &&
              !r &&
              hn(e, function(e, t, n) {
      ...
      function Jt(e) {
        ...
        return !!e &&
          st.call(e) == k &&
          ((t = e.constructor), !Nn(t) || t instanceof t)
          ? (hn(e, function(e, t) {
              n = t;
            }),
            typeof n == "undefined" || ht.call(e, n))
          : !1;
      }
      function Kt(e) {
        return tn[e];
      ...
      function pn(e, t, n) {
        ...
        var i = r.length;
        t = Pt(t, n, 3);
        while (i--) if (t(r[i--], r[i], e) === !1) break;
        return e;
      }
      function vn(e, t, n) {
        var r = Zt(e),
      ...
      function Sn(e) {
        ...
        return n == S ||
          n == A ||
          n == E ||
          (n == k && typeof r == "number" && Nn(e.splice))
          ? !r
          : (dn(e, function() {
              return (t = !1);
            }),
      ...
      function Un(e, t, n) {
        ...
        return (
          ...
          Gt(e)
            ? (o = i(e, t, n) > -1)
            : typeof s == "number"
            ? (o = (_n(e) ? e.indexOf(t, n) : i(e, t, n)) > -1)
            : dn(e, function(e) {
                if (++r >= n) return !(o = e === t);
              }),
          o
      ...
      function Er() {
        ...
        while (++t < n) {
          var a = arguments[t];
          if (Gt(a) || Qt(a))
            e.push(a), r.push(o && a.length >= s && X(t ? e[t] : u));
        }
        var f = e[0],
          l = -1,
          c = f ? f.length : 0,
      ...
      function Fr(e, t) {
        return arguments.length > 2
          ? zt(t, 19, G(arguments, 2), null, e)
          : zt(t, 3, null, null, e);
      }
      function Ir() {
        var e = arguments,
          t = e.length;
        while (t--) if (!Nn(e[t])) throw new tt();
        return function() {
          var t = arguments,
            n = e.length;
      ...
      function Rr(t, n, r) {
        ...
        var v = function() {
            ...
            if (r <= 0) {
              ...
              (s = f = l = e),
                h &&
                  ((c = ri()), (o = t.apply(a, i)), !f && !s && (i = a = null));
            } else f = dt(v, r);
          },
          m = function() {
            f && at(f), (s = f = l = e);
        ...
        return function() {
          ...
          if (h === !1) var e = d && !f;
            ...
            var r = h - (u - c),
              g = r <= 0;
            g
              ? (s && (s = at(s)), (c = u), (o = t.apply(a, i)))
              : s || (s = dt(m, r));
          }
          return (
            g && f ? (f = at(f)) : !f && n !== h && (f = dt(v, n)),
            e && ((g = !0), (o = t.apply(a, i))),
            g && !f && !s && (i = a = null),
            o
          );
      ...
      function Gr(e, t, n) {
        ...
        return i.length == 1 && o === o && !Cn(o)
          ...
          : function(t) {
              var n = i.length,
                r = !1;
              while (n--) if (!(r = Ft(t[i[n]], e[i[n]], null, !0))) break;
              return r;
            };
      }
      function Yr(e) {
      ...
      function ei(e, t, n) {
        var r = !0,
          i = t && mn(t);
        if (!t || (!n && !i.length))
          n == null && (n = t), (s = At), (t = e), (e = Lt), (i = mn(t));
      ...
      function oi(e, t, n) {
        ...
        if (n || e % 1 || t % 1) {
          var s = Ct();
          return Tt(
            e + s * (t - e + parseFloat("1e-" + ((s + "").length - 1))),
            t
          );
        }
        return qt(e, t);
      ...
      function ai(t, n, r) {
        ...
        var x =
          "\n/*\n//# sourceURL=" +
          (r.sourceURL || "/lodash/template/source[" + w++ + "]") +
          "\n*/";
        try {
      ...
      var $t = gt
          ...
          while (++u < a) {
            ...
            if (i && D[typeof i]) {
              var f = -1,
                ...
                c = l ? l.length : 0;
              while (++f < c)
                (r = l[f]), typeof s[r] == "undefined" && (s[r] = i[r]);
            }
          }
          return s;
        },
        hn = function(e, t, n) {
          ...
          t = t && typeof n == "undefined" ? t : Pt(t, n, 3);
          for (r in i) if (t(i[r], r, e) === !1) return s;
          return s;
        },
        dn = function(e, t, n) {
          var r,
      ...
      return (
        ...
        dn(Lt, function(e, t) {
          var n = t !== "sample";
          Lt.prototype[t] ||
            (Lt.prototype[t] = function(t, r) {
              var i = this.__chain__,
                s = e(this.__wrapped__, t, r);
              return !i && (t == null || (r && (!n || typeof t != "function")))
                ? s
                : new At(s, i);
            });
        }),
    ...
    var M = { leading: !1, maxWait: 0, trailing: !1 },
      _ = { configurable: !1, enumerable: !1, value: null, writable: !1 },
      D = {
        boolean: !1,
        function: !0,
        object: !0,
  ...
  define("core/progress", [
    ...
    return { current: i, levels: s, get: o, mark: u, show: a };
  }),
  define("core/loading", ["jQuery"], function(e) {
    var t = function(t) {
      return (
        e(".book").addClass("is-loading"),
        t.always(function() {
    ...
    (e.version = "0.5.2"),
      ...
      (e.Index.prototype.add = function(t, n) {
        ...
        for (var o = 0; o < i.length; o++) {
          ...
          this.tokenStore.add(u, { ref: s, tf: a });
        }
      ...
      (e.stemmer = (function() {
        ...
        return function(n) {
          ...
          return (
            (h = /ll$/),
            (p = new RegExp(a)),
            h.test(n) && p.test(n) && ((h = /.$/), (n = n.replace(h, ""))),
  ...
  define("core/sidebar", [
    ...
    return { init: u, toggle: s, filter: a };
  }),
  define("core/search", [
    "jQuery",
    "lodash",
    ...
    var o = null,
      ...
      p = function() {
        var n = r.get("keyword", "");
        n.length > 0 && (c() || l(), s.filter(t.pluck(f(n), "path"))),
          e(".book-search input").val(n);
      };
    return { init: h, search: f, toggle: l, recover: p };
  }),
  define("core/glossary", ["jQuery", "lodash", "core/state"], function(
    e,
    t,
    n
  ) {
    var r = null,
      ...
      a = function() {
        e(document).on(
          "click",
          ".book-body .page-wrapper .page-inner .glossary-term",
          function(t) {
            t.preventDefault(),
              (location.href =
                n.basePath +
                "/GLOSSARY.html#" +
                e(t.currentTarget).data("glossary-term"));
          }
        );
      },
      f = function(t, n) {
        ...
        t.find("p:contains('" + n.name + "')").each(function(t, i) {
          ...
          (s = s.replace(
            r,
            '<span class="glossary-term" data-glossary-term="' +
              n.id +
              '" title="' +
              n.description +
              '">$1</span>'
  ...
  define("core/navigation", [
    ...
    var a,
      f,
      l = typeof history.pushState != "undefined",
      c = function(n, i) {
        ...
        return s.show(
          e
            .get(u)
            .done(function(t) {
              i && history.pushState({ path: u }, null, u),
                (t = t.replace(/<(\/?)(html|head|body)([^>]*)>/gi, function(
                  e,
                  t,
                  n,
                  r
    ...
    return { init: g, goNext: v, goPrev: m };
  }),
  ...
  define("gitbook", [
    ...
    return { start: p, events: i, state: o };
  });
